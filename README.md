...
<h3 align="center">DevOps Engineer | Cloud & Automation Enthusiast | Tech Community Advocate</h3>
...
I’m a **DevOps Engineer** passionate about building scalable, automated, and secure cloud systems.
With hands-on experience in **Azure, AWS, and DigitalOcean**, I design CI/CD pipelines, containerized deployments, and infrastructure automation using tools like **Docker, Kubernetes, Terraform, and Ansible**.

I’m also a **Microsoft Learn Student Ambassador (Gold)** and **GitHub Campus Expert**, where I advocate for open source and lead initiatives to empower developers and students in my community.

---

### 🚀 What I'm Working On

* 🧩 Advancing DevOps automation with **Terraform, Ansible, and GitHub Actions**
* ☁️ Building **cloud-native and GitOps-driven** deployments on **Azure & AWS**
* 💡 Exploring **Argo CD, Helm, and observability stacks (Prometheus, Grafana, Loki)**
* ✍️ Sharing insights through [technical blogs on Medium](https://medium.com/@shakeelkhuhro)
...
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------- |
| [**PrivacyLens**](https://github.com/Shakeelkhuhro/PrivacyLens)                   | AI-powered privacy policy analyzer using **Azure OpenAI**, React Native, and Express.js.            | Azure OpenAI · Node.js · React Native |
| [**E-Commerce Platform**](https://github.com/Shakeelkhuhro/ExampleCorp-Ecommerce) | Secure MERN app with **Dockerized CI/CD** and **Terraform + Ansible** provisioning on DigitalOcean. | React · Node.js · Terraform · Docker  |
| [**Multi-Service App**](https://github.com/Shakeelkhuhro/Multi-Service-App)       | Microservices app using **Docker Compose**, Nginx, and Redis with centralized secrets & monitoring. | Docker · Nginx · MongoDB              |
| [**Go Web App CI/CD**](https://github.com/Shakeelkhuhro/go-web-app)               | Automated **Kubernetes deployment** with GitHub Actions, Helm, and Argo CD.                         | Go · Helm · Argo CD · GitHub Actions  |
| [**CloudOps Insight**](https://github.com/Shakeelkhuhro/CloudOps-Insight)         | Cloud-native DevOps observability platform with **Prometheus, Grafana, and Terraform automation**.  | Terraform · Prometheus · Grafana      |

---

### 🏅 Certifications

[![Microsoft Certified: Azure Administrator](https://img.shields.io/badge/Microsoft%20Certified-Azure%20Administrator-blue?logo=microsoft)](https://learn.microsoft.com/en-us/users/shakeelkhuhro/)
[![Cisco CCNA](https://img.shields.io/badge/Cisco-CCNA%20Enterprise-blue?logo=cisco)]()
[![Udemy DevOps Professional](https://img.shields.io/badge/Udemy-DevOps%20Professional-orange?logo=udemy)]()
